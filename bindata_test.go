...
func test_wiki_txt() (*asset, error) {
	bytes, err := test_wiki_txt_bytes()
	if err != nil {
		return nil, err
	}
...
var _bintree = &_bintree_t{nil, map[string]*_bintree_t{
	"test": &_bintree_t{nil, map[string]*_bintree_t{
		"wiki.txt": &_bintree_t{test_wiki_txt, map[string]*_bintree_t{
		}},
	}},
}}
